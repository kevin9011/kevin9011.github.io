    ...
    <section id="one">
	    <div class="inner">
		   <header class="major">
            ...
            <h2>Setup</h2>
            <h4>Create a github account and get familiar with github</h4>
            ...
            For using the theme, I simply folk the repository to my github and then change the repository name to anything that I like. For my github page, I rename it to "Blogs".Then I have my starting github page "https://kevin9011.github.io/Blogs/" <br/>
            If you want to choose other theme, you can use following website to choose one you like <br/>
